...
%bcond_with zfs
%bcond_with lustre_tests
%bcond_with lustre_utils
%bcond_with lustre_iokit
...
%if %{undefined lustre_name}
    %if %{with servers}
        %global lustre_name lustre%{PROJ_DELIM}
    %else
        %global lustre_name lustre-client%{PROJ_DELIM}
    %endif
%endif
